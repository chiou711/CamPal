...
import com.cw.campal.operation.import_export.ParseXmlToDB;
...
//		String srcUrl =   "https://drive.google.com/uc?authuser=0&id=1qAfMUJ9DMsciVkb7hEQAwLrmcyfN95sF&export=download";
		...
		String targetUrl = "file://" + "/storage/emulated/0/CamPal" + "/default_content_by_download.xml";
		...
		request.setTitle("CamPal download");
